  ...
  return (
    <>
      <div className={styles.wrapper}>
        ...
        <div className="mt_32">
          <p className="text_sub">{t("errorPage.404.title")}</p>
          <p className="text_sub">{t("errorPage.404.subTitle")}</p>
        </div>
        <p className="mt_24 text_16">{t("errorPage.404.content")}</p>
        <p className={styles.error_number}>{t("errorPage.404.error")}</p>
