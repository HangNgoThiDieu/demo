      ...
      .catch((err: any) => {
        ...
        switch (err.errorCode) {
          case UsersStatusResponse.NotFound:
            ...
            break;
          case UsersStatusResponse.PasswordNotCorrect:
            setShowMessage(true);
            setMessageError(
              t("password.changePassword.validation.passwordNotCorrect")
            );
            break;
          case UsersStatusResponse.DuplicateOldPassword:
            setShowMessage(true);
            setMessageError(t("password.changePassword.validation.duplicatedOldPassword"));
            break;
        ...
        <form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
          <div className={styles.main_content}>
            ...
            <ul>
              ...
              <li>
                <Label text={t("password.changePassword.currentPassword")} />
                <input
                  type="password"
                  ...
                  {...register("oldPassword", {
                    required: {
                      ...
                      message: t("validation.required", {
                        field: t("password.changePassword.currentPassword"),
                      }),
                    },
                    pattern: {
